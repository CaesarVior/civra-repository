                ...
                <div class="flex flex-col lg:flex-row lg:items-center gap-4 mb-4">
                    ...
                    <div class="flex flex-row w-full gap-3 order-last lg:order-first">
                        ...
                        <select id="statusFilter"
                            ...
                            <option value=""><span>{{ __('admin-user.index-status') }}</span></option>
                            <option value="pending">{{ __('admin-user.index-list-status-pending') }}</option>
                            <option value="publish">{{ __('admin-user.index-list-status-publish') }}</option>
                            <option value="unpublish">{{ __('admin-user.index-list-status-unpublish') }}</option>
                        </select>
                    </div>
                </div>
            </div>
                        ...
                        <thead class="bg-[#F7F6FE]">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-center text-sm font-bold text-gray-700 w-64">
                                    <span>{{ __('admin-user.index-table-title') }}</span>
                                </th>
                                <th class="px-4 py-3 text-center text-sm font-bold text-gray-700 w-24">
                                    <span>{{ __('admin-user.index-table-image') }}</span>
                                </th>
