pipeline {
    ...
    environment {
        DISCORD_WEBHOOK = credentials('https://discord.com/api/webhooks/1354805761280315442/WBWj1zEx8LaM5SYJVJcVrW49n4M20BA4dUUg6gm9CXsoBECKnwbAm7m0wevYo4ORKOpd') 
    }
    ...
    stages {
        ...
        stage('Laravel Post-Deployment') {
            steps {
                ...
                sh 'sleep 10' 
                sh 'docker exec artisantz_app php artisan migrate --force'
                sh 'docker exec artisantz_app php artisan optimize:clear'
            }
        }
    }
